# Flash Alarm Notify Specification

## Purpose
Define requirements for an Android native flash alarm notification path that produces strong short vibration on phone and connected smartwatch.
